...
import { Layout, Menu, Badge, Dropdown, Tag, Breadcrumb, ConfigProvider, Button } from 'antd';
...
function ClientLayoutInner({ children, breadcrumbs = [] }) {
    ...
    const menuItems = [
        ...
        { key: '/client/wallet/transactions', icon: <SwapOutlined />, label: <Link href="/client/wallet/transactions">Transactions</Link> },
...
export default function ClientLayout({ children, breadcrumbs = [] }) {
    return (
        <CartProvider>
            <ClientLayoutInner breadcrumbs={breadcrumbs}>
                {children}
            </ClientLayoutInner>
        </CartProvider>
    );
